SELECT supp_nation, cust_nation, l_year, pac_sum(hash(shipping.c_custkey), volume) AS revenue
FROM (SELECT c_custkey, n1.n_name AS supp_nation, n2.n_name AS cust_nation,
